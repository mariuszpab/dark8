...
class PerformanceProfiler:
    ...
    def profile_function(self, func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            if profile_key not in self.function_profiles:
                self.function_profiles[profile_key] = FunctionProfile(name=func_name, module=module)
    ...
    def record_cpu_sample(self, usage_percent: float) -> None:
        ...
        sample = {"timestamp": datetime.now().isoformat(), "usage_percent": usage_percent}
...
def test_performance_profiler():
    ...
    # Memory samples
    for _ in range(10):
        profiler.record_memory_sample(used_mb=random.uniform(100, 300), available_mb=2000)
