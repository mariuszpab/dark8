...
class Dashboard:
    ...
    def add_widget(
        self, dashboard_name: str, widget_name: str, metric_name: str, widget_type: str = "graph"
    ) -> bool:
        """
    ...
    def get_dashboard_data(self, dashboard_name: str) -> Dict:
        ...
        data = {"name": dashboard["name"], "created_at": dashboard["created_at"], "widgets": []}
...
class Logger:
    ...
    def query_logs(
        self, level: Optional[str] = None, component: Optional[str] = None, limit: int = 100
    ) -> List[Dict]:
        """Zapytanie do logów"""
